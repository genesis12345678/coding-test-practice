...
<p>예를 들어 <code data-sider-select-id="530d8480-cc0a-4178-bd68-29ef8ad50392">CAR_RENTAL_COMPANY_RENTAL_HISTORY</code> 테이블이 다음과 같다면</p>
<table class="table">
        <thead><tr>
<th>HISTORY_ID</th>
<th>CAR_ID</th>
